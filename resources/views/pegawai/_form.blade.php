...
<form action="{{ $action }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-sm rounded-lg p-6 space-y-4">
    @csrf
    ...
    <div>
        ...
        <input id="tanda_tangan" name="tanda_tangan" type="file" accept="image/png,image/jpeg" class="mt-1 block w-full text-sm">
    ...
    <div class="flex items-center justify-end gap-3">
        <a href="{{ route('pegawai.index') }}" class="px-4 py-2 text-sm text-gray-600">Batal</a>
